...
export const fetchGetPaymentMethodById = (id) => axios.get(`/api/payment-methods/${id}`);

export const postCreatePaymentMethod = (data) => axios.post("/api/payment-methods", data);
